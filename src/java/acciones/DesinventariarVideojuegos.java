...
/**
 * Este servlet actualiza desinventaria un videojuego de la base de datos
 * videocentro. El servlet obtiene del objeto request la lista del inventario
 * de videojuegos.. 
 * El servlet verifica que s.
 * 
 * @author Emilio AndreaBorboa
 */
@WebServlet(name = "DesinventariarVideojuego", urlPatterns = {"/DesinventariarVideojuego"})
public class DesinventariarVideojuegos extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Videojuego videojuego = new Videojuego(request.getParameter("clave"));
             ...
             if( crud.obten(videojuego)!=null){
               crud.desinventariar(videojuego,Integer.valueOf(request.getParameter("cantidad")));
